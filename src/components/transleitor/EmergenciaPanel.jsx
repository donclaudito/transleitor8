...
import { ChevronDown, ChevronRight, PanelLeft, Search, Stethoscope, Activity, ClipboardList, FlaskConical, Ambulance, AlertTriangle, Wrench } from 'lucide-react';
...
const EMERGENCIA_DATA = {
  cincoW: {
    ...
    groups: [
      {
        label: 'Wind (Vento/Pulmão — DPO 1–2)',
        items: [
          'Atelectasia', 'Pneumonia', 'TEP', 'Falta de ar referida', 'Tosse', 'Dor para respirar fundo',
        ],
      },
      {
        label: 'Water (Água/Urina — DPO 3–5)',
        items: [
          'Infecção do trato urinário (ITUs)', 'Sonda vesical de demora previa', 'Ardência ao urinar', 'Urina escura/turva',
        ],
      },
      {
        label: 'Wound (Ferida — DPO 5–7)',
        items: [
          'Infecção de sítio cirúrgico (ISC)', 'Dor na ferida piorando', 'Ferida quente', 'Eritema na ferida',
        ],
      },
      {
        label: 'Walking (Caminhada/Pernas — DPO 7+)',
        items: [
          'Trombose venosa profunda (TVP)', 'Panturrilha inchada', 'Panturrilha dolorida', 'Edema assimétrico em MMII',
        ],
      },
      {
        label: 'Wonder Drugs (Drogas — qualquer DPO)',
        items: [
          'Febre por medicamento', 'Reação a antibiótico', 'Reação a heparina', 'Farmacoderme',
        ],
      },
    ],
  },
  bedside: {
    ...
    groups: [
      {
        label: 'Regra de Ouro da Ferida (tire o curativo)',
        items: [
          'Curativo removido e ferida examinada', 'Flutuação (abscesso/seroma infectado)', 'Eritema além das bordas (celulite/erisipela)', 'Saída de pus pela ferida', 'Saída de fezes pela ferida (fístula/deiscência)', 'Deiscência parcial', 'Deiscência de aponeurose', 'Evisceração',
        ],
      },
      {
        label: 'Teste do Abdome',
        items: [
          'Abdome flácido e indolor', 'Distensão + vômitos + ausência de gases (obstrução por bridas/íleo)', 'Dor à descompressão brusca (Blumberg) — PERITONITE', 'Defesa abdominal', 'Abdome em tábua', 'Massa palpável',
        ],
      },
      {
        label: 'Avaliação de Drenos',
        items: [
          'Drenos pérvios', 'Dreno obstruído', 'Dreno arrancado acidentalmente', 'Líquido mudou de cor', 'Débito aumentou', 'Débito purulento/bilioso/entérico',
        ],
      },
    ],
  },
  procedimentos: {
    ...
    groups: [
      {
        label: 'Resolutivos na própria sala',
        items: [
          'Abertura de pontos/retirada de grampos (drenar abscesso superficial)', 'Lavagem da ferida + curativo', 'Punção de seroma (técnica estéril)', 'Retirada de corpo estranho (fio não absorvível/granuloma)', 'Drenagem de hematoma infectado', 'Alta com curativos diários no posto de saúde',
        ],
      },
    ],
  },
  exames: {
    ...
    groups: [
      {
        label: 'Ultrassom Bedside (POCUS)',
        items: [
          'Coleção na ferida (líquido vs flegmão)', 'Doppler de MMII (TVP)', 'Via biliar (colecistectomia com dor residual)', 'Via renal (nefrectomia com dor residual)',
        ],
      },
      {
        label: 'Imagem Rápida',
        items: [
          'RX abdome em pé (níveis hidroaéreos — obstrução)', 'RX abdome em pé (pneumoperitônio — perfuração)', 'TC abdome/pelve com contraste (definitivo)', 'TC com abscesso intra-abdominal', 'TC com fístula anastomótica',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        label: '🟢 Alta Imediata',
        items: [
          'Seroma não infectado', 'Dor muscular residual', 'Constipação leve', 'ISC superficial drenada na sala', 'Prescrição oral + curativo + return precautions',
        ],
      },
      {
        label: '🟡 Internação Enfermaria',
        items: [
          'Celulite extensa (ATB EV)', 'Íleo paralítico prolongado (SNG + hidratação)', 'Abscesso intra-abdominal pequeno (ATB/drenagem percutânea RI)',
        ],
      },
      {
        label: '🟠 Internação UTI',
        items: [
          'Sepse de foco abdominal', 'Idoso com comorbidades descompensando', 'Fístula digestiva de alto débito', 'Ressuscitação volêmica + ATB amplo espectro',
        ],
      },
      {
        label: '🔴 Centro Cirúrgico Imediato',
        items: [
          'Deiscência de aponeurose com evisceração', 'Sangramento ativo com instabilidade', 'Peritonite generalizada', 'Isquemia intestinal', 'Jejum + acesso calibroso + avisar CC',
        ],
      },
    ],
  },
  armadilhas: {
    ...
    groups: [
      {
        label: 'Pegadinhas que matam',
        items: [
          'Dor "diferente"/desproporcional no DPO 3 = isquemia de alça/trombose de enxerto', 'Idoso/imunossuprimido sem febre e sem abdome rígido (taquicardia + confusão = catástrofe)', 'Alta no DPO 5 (vazamento de anastomose) sem return precautions', 'Não ler boletim cirúrgico / não ligar para cirurgião original',
        ],
      },
    ],
  },
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="w-full max-w-4xl max-h-[92vh] flex flex-col bg-card rounded-2xl border border-border shadow-2xl overflow-hidden">
              <div className="px-5 py-4 border-b border-border flex-shrink-0 space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Fast-Track cirúrgico — filtro de alto nível: resolver na hora, internar ou CC imediato</p>
                  </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Buscar itens da avaliação cirúrgica..."
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2">
                {Object.entries(EMERGENCIA_DATA).map(([key, section]) => (
                  <SectionAccordion
                    key={key}
                    section={section}
