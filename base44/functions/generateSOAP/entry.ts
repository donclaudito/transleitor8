...
const SOAP_SYSTEM_MESSAGE = [
  ...
  '12. Separe o texto em DUAS PARTES: fatos objetivos; e "Pontos em Aberto" (o que não tem informação suficiente para avaliar, ambiguidades registradas como PERGUNTAS, o que não pôde ser avaliado e por quê, e pendências que condicionam as condutas possíveis).',
...
const SOAP_SYSTEM_MESSAGE_TEXT = [
  ...
  '8. Separe o texto em DUAS PARTES: fatos objetivos; e "Pontos em Aberto" (informação insuficiente, ambiguidades como PERGUNTAS, o que não pôde ser avaliado e por quê, pendências). Omissão silenciosa é proibida: declare toda omissão.',
  '9. Máximo 30 linhas no total (se não couber, corte o menos relevante). "Pontos em Aberto": só o que muda a conduta, máximo 5. Sem valores numéricos exatos de exames, sinais vitais, diurese, peso, IMC ou horários — use termos qualitativos. Sem acesso venoso, fralda, acompanhante, horário de procedimento, curativo, cateteres ou fisioterapia. Não cruze registros de outras categorias entre si salvo contradição que mude a conduta (uma linha). Não repita informação entre seções; não liste dados ausentes que não mudem decisão. Dado ambíguo: registre como PERGUNTA em "Pontos em Aberto" — não decida sozinho.',
  '',
  'REDAÇÃO FINAL (OBRIGATÓRIA):',
