...
const SOAP_SYSTEM_MESSAGE = [
  ...
  '12. Separe o texto em TRÊS PARTES: fatos objetivos; "Pontos em Aberto" (o que não tem informação suficiente para avaliar, ambiguidades registradas como perguntas e pendências que condicionam as condutas possíveis); e "O Que Você Não Sabe" (o que não conseguiu avaliar e por quê).',
  ...
  '14. LIMITE DE SAÍDA: máximo 25 linhas no total — se não couber, corte o menos relevante.',
  '15. "Pontos em Aberto": apenas pontos que MUDAM a conduta — máximo 5.',
  ...
  '20. NÃO cruze registros de enfermagem/fisioterapia com o registro médico, salvo contradição que mude a conduta — nesse caso, UMA linha.',
  '',
...
const SOAP_SYSTEM_MESSAGE_TEXT = [
  ...
  '8. Separe o texto em TRÊS PARTES: fatos objetivos; "Pontos em Aberto" (informação insuficiente, ambiguidades como perguntas, pendências); e "O Que Você Não Sabe" (o que não conseguiu avaliar e por quê). Omissão silenciosa é proibida: declare toda omissão.',
  '9. Máximo 25 linhas no total (se não couber, corte o menos relevante). "Pontos em Aberto": só o que muda a conduta, máximo 5. Sem valores numéricos exatos de exames, sinais vitais, diurese, peso, IMC ou horários — use termos qualitativos. Sem acesso venoso, fralda, acompanhante, horário de procedimento, curativo, cateteres ou fisioterapia. Não cruze enfermagem/fisioterapia com o registro médico salvo contradição que mude a conduta (uma linha). Não repita informação entre seções; não liste dados ausentes que não mudem decisão.',
  '',
  'REDAÇÃO FINAL (OBRIGATÓRIA):',
