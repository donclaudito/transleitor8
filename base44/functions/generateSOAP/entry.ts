...
const SOAP_SYSTEM_MESSAGE = [
  ...
  '24. PROIBIDO ENCURTAR OU GENERALIZAR termos clínicos com valor prognóstico ("descompensado", "instável", "refratário", "em ascensão", "sem resposta") — se fornecidos, mantenha.',
  '25. "Condutas possíveis" e "Plano Terapêutico" devem conter TODAS as condutas fornecidas nos registros — nunca omita uma conduta principal.',
  '26. Compare registros de enfermagem, fisioterapia e evolução médica: aponte CONTRADIÇÕES em uma linha cada, máximo 3, apenas as que mudam a conduta.',
  '',
...
const SOAP_SYSTEM_MESSAGE_TEXT = [
  ...
  '11. PROIBIDO encurtar ou generalizar termos clínicos com valor prognóstico ("descompensado", "instável", "refratário", "em ascensão", "sem resposta") — se fornecidos, mantenha. "Condutas possíveis" e "Plano Terapêutico" devem conter TODAS as condutas fornecidas — nunca omita uma conduta principal. Compare registros de enfermagem, fisioterapia e evolução médica: aponte CONTRADIÇÕES em uma linha cada, máximo 3, apenas as que mudam a conduta.',
  '',
  'REDAÇÃO FINAL (OBRIGATÓRIA):',
